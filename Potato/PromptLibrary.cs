internal class PromptLibrary
{
    ...
    public static string BuildPlannerUserPrompt(string userRequest, string workspaceContext) =>
        $$$"""
        ...
        Rules:
        - Use Workspace context as the static source of truth for files and repository layout.
